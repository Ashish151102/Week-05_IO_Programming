package com.ioprogramming.day2.handsonpractice.filterrecords;
...
public class JSONFilter {
    public static void main(String[] args) {
        try{
            ...
            List<com.ioprogramming.day2.practiceproblems.filterrecords.Person> persons = objectMapper.readValue(jsonData, new TypeReference<List<com.ioprogramming.day2.practiceproblems.filterrecords.Person>>() {});

            List<com.ioprogramming.day2.practiceproblems.filterrecords.Person> filteredPersons = new ArrayList<>();
